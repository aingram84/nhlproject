...
//   console.log("Team 8: " + w8t);
  ...
  var e1t = nhleast[E1];
  nhleast.splice(E1,1);
  var E2 = Math.floor(Math.random()*15);
  var e2t = nhleast[E2];
  nhleast.splice(E2,1);
  var E3 = Math.floor(Math.random()*14);
  var e3t = nhleast[E3];
  nhleast.splice(E3,1);
  var E4 = Math.floor(Math.random()*13);
  var e4t = nhleast[E4];
  nhleast.splice(E4,1);
  var E5 = Math.floor(Math.random()*12);
  var e5t = nhleast[E5];
  nhleast.splice(E5,1);
  var E6 = Math.floor(Math.random()*11);
  var e6t = nhleast[E6];
  nhleast.splice(E6,1);
  var E7 = Math.floor(Math.random()*10);
  var e7t = nhleast[E7];
  nhleast.splice(E7,1);
  var E8 = Math.floor(Math.random()*9);
  var e8t = nhleast[E8];
  nhleast.splice(E8,1);
